                                    ...
                                    <div class="order-progress">
                                        <ul>
                                            <li class="first active">
                                                ...
                                                <div class="info">{{goodslist.add_time | cutTime('YYYY-MM-DD hh:mm:ss')}}</div>
                                            </li>
                                            <li class="">
                                                <div class="progress">已付款</div>
                                                <div class="info">{{goodslist.payment_time | cutTime('YYYY-MM-DD hh:mm:ss')}}</div>
                                            </li>
                                            <li class="">
                                                <div class="progress">已经发货</div>
                                                <div class="info">{{goodslist.express_time | cutTime('YYYY-MM-DD hh:mm:ss')}}</div>
                                            </li>
                                            <li class="last">
                                                <div class="progress">已完成</div>
                                                <div class="info">{{goodslist.complete_time | cutTime('YYYY-MM-DD hh:mm:ss')}}</div>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="form-box accept-box form-box1">
                                        <dl class="head form-group">
                                            <dd>
                                                ...
                                                <router-link v-if="orderinfo.status==1" to="/orderInfo" class="btn-pay">去付款</router-link>
                                                <!---->
                                            </dd>
                                        </dl>
                                        <dl class="form-group">
